...
size_strain_path = "/Volumes/X9/src/Python/fairmofsyncondition/data/json_data/mof_size_strain.json"
...
def data_files(ligand_solvent_path, size_strain_path, category_path):
    ...
    return ligand_solvent, size_strain, ligand_cat, salt_cat, solvent_cat


def save2lmbt(lmdb_path, ligand_solvent_path, size_strain_path, category_path):
    file_mapper = {}
    with lmdb.open(lmdb_path, map_size=int(1e12)) as lmdb_env:
        with lmdb_env.begin(write=True) as txn:
            ...
            for i, refcode in enumerate(all_refs):
                try:
                    print(i, refcode)
...
save2lmbt(lmdb_path, ligand_solvent_path, size_strain_path, category_path)
